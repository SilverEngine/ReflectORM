...
trait QueryJoin
{
	...
	public function rightJoin($table,$condition = []): object
	{
		return $this->doJoin($table, $condition, 'right');
	}

	public function ref($ref, ...$args): object
	{
	...
	private function doJoin($table, $condition, string $type): object
	{
	...
	protected static function compileJoin(object $q): string
	{
		if ($q->joins) {
			$ret = array_map(
				function ($join) {
